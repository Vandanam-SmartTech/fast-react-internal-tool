...
export default function SolarInstallationForm() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="w-full max-w-6xl bg-white rounded-lg shadow-lg p-6 sm:p-8">
        <h2 className="text-center text-xl sm:text-2xl font-bold text-blue-900 mb-6">
          Solar Installation Form
        </h2>

        <form onSubmit={handleSubmit} className="space-y-6">
          <fieldset className="border-2 border-blue-500 p-4 sm:p-6 rounded-lg">
