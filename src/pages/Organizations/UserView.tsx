    ...
    <div className="min-h-screen bg-gray-50 py-3 sm:py-4">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2 min-w-0">
          ...
          <h1 className="font-bold text-gray-900 truncate">
            <span className="text-lg sm:text-2xl">
              <span className="sm:hidden">User Details</span>
        ...
        <button
          ...
          className="bg-blue-600 text-white px-3 py-2 sm:px-4 sm:py-2 rounded-lg
               flex items-center gap-1 sm:gap-2 hover:bg-blue-700 shrink-0"
        >
      ...
      <div className="bg-white rounded-lg shadow p-4">
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-gray-800">{user.nameAsPerGovId || '-'}</p>
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-500 mb-1">Preferred Name</label>
            <p className="mt-1 text-sm text-gray-800">{user.preferredName || '-'}</p>
          </div>
              ...
              <div className="space-y-2">
                {Object.values(
                  ...
                  <div key={index} className="flex items-center gap-2">
                    <span className="font-medium text-sm text-gray-800">{org.org}:</span>
          ...
          <div className='col-span-2'>
            <div>
              ...
              <p className="mt-1 text-sm text-gray-800">{`${user.addressLine1}, ${user.villageName}, ${user.talukaName}, ${user.districtName}, ${user.pinCode}`}</p>
            </div>
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-gray-800">{user.managerName || '-'}</p>
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-500 mb-1">Manager Email</label>
            <p className="mt-1 text-sm text-gray-800">{user.managerEmail || '-'}</p>
          </div>
