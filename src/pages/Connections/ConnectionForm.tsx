...
import { Bolt, MapPin, Building, Phone, Mail, AlertCircle, CheckCircle, Globe, Zap, Home, Settings } from "lucide-react";
        ...
        <div className="mb-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Add Connection Details</h1>
                <p className="text-gray-600 mt-1">Configure electrical connection information</p>
              </div>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 pr-12 border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:outline-none transition-all duration-200 bg-gray-50 hover:bg-white disabled:bg-gray-100 disabled:cursor-not-allowed"
                  ...
                  >
                    {showConsumerNumber ? <FaEyeSlash className="h-5 w-5" /> : <FaEye className="h-5 w-5" />}
                  </button>
                </div>
                {formData.consumerId?.length === 12 && !/^[0-9]{12}$/.test(formData.consumerId) && (
                  <div className="flex items-center gap-2 text-red-500 text-sm">
                    <AlertCircle className="h-4 w-4" />
                    Enter a valid 12-digit consumer number
                  </div>
                )}
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  disabled={!(/^[0-9]{12}$/.test(formData.consumerId) && !consumerNumberExists)}
                  onCopy={(e) => e.preventDefault()}
                  onCut={(e) => e.preventDefault()}
                  onPaste={(e) => e.preventDefault()}
                />
                {confirmConsumerNumber && confirmConsumerNumber !== formData.consumerId && (
                  <div className="flex items-center gap-2 text-red-500 text-sm">
                    <AlertCircle className="h-4 w-4" />
            ...
            <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl p-6 border border-purple-200">
              ...
              {formData.latitude && formData.longitude && !isNaN(Number(formData.latitude)) && !isNaN(Number(formData.longitude)) && (
                <div className="mt-6">
                  ...
                  {showMapPreview && (
                    <div className="w-full h-[300px] rounded-xl overflow-hidden border-2 border-purple-200 shadow-lg">
                      <MapPreview
            ...
            <div className="flex justify-center pt-6">
              <button
                type="submit"
                className="px-8 py-4 bg-gradient-to-r from-green-600 to-blue-600 text-white font-semibold rounded-xl hover:from-green-700 hover:to-blue-700 focus:outline-none focus:ring-4 focus:ring-green-300 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 flex items-center gap-2"
              >
